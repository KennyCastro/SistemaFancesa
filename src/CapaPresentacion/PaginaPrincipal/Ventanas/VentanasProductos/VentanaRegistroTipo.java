 ...
 * @author KENNY
 */
public class VentanaRegistroTipo extends javax.swing.JFrame {

    int xMouse,  yMouse;
    ExpresionesRegulares expresiones= new ExpresionesRegulares();
    public VentanaRegistroTipo() {
        initComponents();
        centrarPantalla();
        IniciarId();
    }
    ...
    private void initComponents() {
        ...
        cajaNombreTipo = new javax.swing.JTextField();
        ...
        jLabel4.setText("Registro Tipos de Productos");
        ...
        cajaIdTipo.setEditable(false);
        cajaIdTipo.setBackground(new java.awt.Color(255, 255, 255));
        cajaIdTipo.setFont(new java.awt.Font("Roboto Medium", 1, 24)); // NOI18N
        ...
        cajaNombreTipo.setBackground(new java.awt.Color(255, 255, 255));
        cajaNombreTipo.setFont(new java.awt.Font("Roboto Medium", 1, 24)); // NOI18N
        cajaNombreTipo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cajaNombreTipoActionPerformed(evt);
            }
        });
            ...
            .addGroup(vent_Inicial_Productos1Layout.createSequentialGroup()
                ...
                .addGroup(vent_Inicial_Productos1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(vent_Inicial_Productos1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cajaIdTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 291, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(vent_Inicial_Productos1Layout.createSequentialGroup()
                        .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cajaNombreTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 291, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        vent_Inicial_Productos1Layout.setVerticalGroup(
            ...
            .addGroup(vent_Inicial_Productos1Layout.createSequentialGroup()
                ...
                .addGroup(vent_Inicial_Productos1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cajaIdTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(50, 50, 50)
                .addGroup(vent_Inicial_Productos1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(cajaNombreTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(52, 52, 52)
                .addGroup(vent_Inicial_Productos1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void cajaNombreTipoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cajaNombreTipoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cajaNombreTipoActionPerformed
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if(cajaNombreTipo.getText().length()==0) {//esta vacio
            JOptionPane.showConfirmDialog(null, "Ingrese nombre del tipo de producto","VENTANA DE INFORMACIÓN", JOptionPane.CLOSED_OPTION, JOptionPane.INFORMATION_MESSAGE);
            cajaNombreTipo.requestFocus();
            return;
        }

        if(!expresiones.validarNombreUnidad(cajaNombreTipo.getText())){
            JOptionPane.showConfirmDialog(null, "Ingrese Nombre del tipo de producto correcto","VENTANA DE INFORMACIÓN", JOptionPane.CLOSED_OPTION, JOptionPane.INFORMATION_MESSAGE);
            cajaNombreTipo.requestFocus();
            return;
        }
        ...
        datosTipoProducto datos = new datosTipoProducto();
        conexionTipoProducto fun = new conexionTipoProducto();

        datos.setIdTipo(cajaIdTipo.getText());
        datos.setNombreTipo(cajaNombreTipo.getText());
       

        if(accionTipo=="crear"){
            fun.registrarDatos(datos);
            JOptionPane.showConfirmDialog(null, "Tipo de producto creado","VENTANA DE INFORMACIÓN", JOptionPane.CLOSED_OPTION, JOptionPane.INFORMATION_MESSAGE);

        } else {
            fun.editarDatos(datos);
            JOptionPane.showConfirmDialog(null, "Tipo de producto editado","VENTANA DE INFORMACIÓN", JOptionPane.CLOSED_OPTION, JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (fun.verificarRegistroExistente(cajaIdTipo.getText())==1){
            int confirmacion = JOptionPane.showConfirmDialog(rootPane, "Desea eliminar el tipo de producto?","Confirmar",2);
            if(confirmacion==0){
                datos.setIdTipo(cajaIdTipo.getText());
                fun.eliminarDatos(datos);
                JOptionPane.showConfirmDialog(null, "tipo de producto eliminado","VENTANA DE INFORMACIÓN", JOptionPane.CLOSED_OPTION, JOptionPane.INFORMATION_MESSAGE);
                dispose();
                inventario= new Ventana_Inventario();
                setForm(inventario);
            }
            ...
            JOptionPane.showConfirmDialog(null, "No existe el tipo de producto","VENTANA DE INFORMACIÓN", JOptionPane.CLOSED_OPTION, JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaRegistroTipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaRegistroTipo().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField cajaIdTipo;
    private javax.swing.JTextField cajaNombreTipo;
    ...
    private void IniciarId() {
          ...
          if (IdTipo =="") {
            ...
            conexionTipoProducto fun = new conexionTipoProducto();
            datosTipoProducto registro = fun.devolverDatos(IdTipo);

            if(registro!= null) {
                cajaIdTipo.setText(registro.getIdTipo());
                cajaNombreTipo.setText(registro.getNombreTipo());
            }
        }
        IdTipo="";
    ...
    private void generarID(){
        ...
        cajaIdTipo.setText(formato.format(fun.generarIdTipo()));
    }
